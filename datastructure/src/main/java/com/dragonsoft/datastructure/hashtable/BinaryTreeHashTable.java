 ...
 *
 */
public class BinaryTreeHashTable {
	private BinaryTree[] hashTable = new BinaryTree[10];
...
//		BinaryTree binaryTree = hashTable[hashKey];
//		if(binaryTree == null) {
//			binaryTree = new BinaryTree();
//			//把创建出来的链表放入到二叉树中
//			hashTable[hashKey] = binaryTree;
//		}
////		binaryTree.addElement(node);
//	}
//
